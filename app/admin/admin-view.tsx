  ...
  return <main className="admin-page">
    ...
    <section className="admin-intro">
      <div>
        ...
        <p>This first admin foundation edits a local browser draft of the verified project catalog. Authentication and shared storage come next with Supabase.</p>
      </div>
      <div className="admin-actions"><button className="primary" onClick={saveDraft}>Save local draft <span>↗</span></button><button className="text-link" onClick={resetDraft}>Reset draft</button></div>
    </section>
    ...
    <section className="admin-shell" aria-label="Project content workspace">
      ...
      <article className="admin-editor">
        ...
        <div className="editor-foot"><label className="check-row"><input type="checkbox" checked={selected.featured} onChange={(event) => updateSelected({ featured: event.target.checked })} /> Featured project</label><span>{saved ? 'Draft saved in this browser.' : 'Unsaved local changes.'}</span></div>
      </article>
    </section>
