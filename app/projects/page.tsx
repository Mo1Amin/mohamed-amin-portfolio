...
export default function ProjectsPage() {
  return <main className="route-page">
    <header className="route-header"><Link className="brand" href="/">ma<span>↗</span></Link><div className="route-header-actions"><RouteControls /><Link className="text-link" href="/">← Back to portfolio</Link></div></header>
